...
#include <GsTLAppli/gui/ui_general_display_pref_panel_base.h> 
#include <qstring.h>
...
class GUI_DECL General_display_pref_panel : public QWidget, public Ui::General_display_pref_panel_base { 
